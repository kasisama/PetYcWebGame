...
//#region node_modules/.nitro/vite/services/ssr/assets/router-CTHm0hS-.js
var router_CTHm0hS__exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-D2_sb6av.css";
var APP_NAME = "宠物养成";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "把调查队带进网页：领养伙伴、陪伴、探索与进化。"
			}
		],
		links: [
			{
...
var $$splitComponentImporter = () => import("./routes-CNsTQwlq.mjs");
...
//#endregion
export { getRouter, router_CTHm0hS__exports as t };
